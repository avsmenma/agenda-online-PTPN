...
{{-- ==== Modal Kustomisasi Kolom (disalin daftarDokumenTabulator.blade.php:206-314, self-contained per CLAUDE.md §7) ==== --}}
...
@push('styles')
    ...
    /* Modal Customization Styles (disalin daftarDokumenTabulator.blade.php:329-397, self-contained per CLAUDE.md §7) */
...
@push('scripts')
{{-- Kustomisasi Kolom — JS disalin dari daftarDokumenTabulator.blade.php:460-721 (self-contained
     per CLAUDE.md §7), dengan appendActiveFilterInputs() ditulis ulang untuk membawa filter
     toolbar akutansi (search/status/filter_dari) alih-alih year/status_filter operator.
     Akutansi tak punya create/destroy — JS Hapus/Detail view operator TIDAK disalin. --}}
<script>
