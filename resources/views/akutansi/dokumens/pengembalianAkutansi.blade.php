    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content" style="border-radius: 16px; overflow: hidden;">
        <div class="modal-header"
          style="background: linear-gradient(135deg, #083E40 0%, #0a4f52 100%); color: white; border: none;">
            ...
            <div class="col-12">
              <div class="card" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                <div class="card-header"
                  style="background: linear-gradient(135deg, #083E40 0%, #0a4f52 100%); color: white; font-weight: 600;">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    ...
                    <div class="col-md-3"><strong>Jenis Sub Pekerjaan:</strong> <span
                        id="view-jenis-sub-pekerjaan">-</span></div>
                    <div class="col-md-3"><strong>Kriteria CF:</strong> <span id="view-kategori">-</span></div>
                    <div class="col-md-3"><strong>Jenis Pembayaran:</strong> <span id="view-jenis-pembayaran">-</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6"><strong>Ejaan Nilai Rupiah:</strong> <span id="view-ejaan-nilai-rupiah">-</span>
                    </div>
              ...
              <div class="card" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    ...
                    <div class="col-md-4"><strong>Tanggal Berakhir SPK:</strong> <span
                        id="view-tanggal-berakhir-spk">-</span></div>
                    <div class="col-md-6"><strong>No Berita Acara:</strong> <span id="view-no-berita-acara">-</span></div>
                    <div class="col-md-6"><strong>Tanggal Berita Acara:</strong> <span
                        id="view-tanggal-berita-acara">-</span></div>
                  </div>
                </div>
              </div>
            </div>
