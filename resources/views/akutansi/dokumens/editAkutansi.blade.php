...
<div class="info-alert">
  ...
  <div class="info-alert-content">
    ...
    <p class="info-alert-text">
      Sebagai Team Akutansi, Anda dapat mengedit semua data dokumen. Perubahan yang Anda lakukan akan tersimpan dan dapat dilihat oleh semua pihak terkait. Data dari role lain (Perpajakan) ditampilkan sebagai referensi dan tidak dapat diedit.
    </p>
  </div>
</div>
    ...
    <div class="accordion-section perpajakan-section">
      ...
      <div class="accordion-content active">
        <div class="accordion-body">
          ...
          <div style="margin-top: 15px;">
            <div class="info-item">
              <div class="info-label">Link Dokumen Pajak</div>
              <div class="info-value">
                <a href="{{ $dokumen->link_dokumen_pajak }}" target="_blank" style="color: #007bff; text-decoration: underline;">
                  <i class="fa-solid fa-external-link-alt"></i> {{ $dokumen->link_dokumen_pajak }}
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="text"
                     name="nomor_miro"
                     id="nomor_miro"
                     placeholder="Masukkan nomor MIRO"
