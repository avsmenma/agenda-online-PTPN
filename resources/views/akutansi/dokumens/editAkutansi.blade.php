...
@section('content')
  ...
  <div class="card mb-4 p-3"
    ...
    <h2 class="form-title">Edit <span>Dokumen - Team Akutansi</span></h2>
  </div>
  ...
  <div class="info-alert">
    ...
    <div class="info-alert-content">
      ...
      <p class="info-alert-text">
        Sebagai Team Akutansi, Anda dapat mengedit semua data dokumen. Perubahan yang Anda lakukan akan tersimpan dan
        dapat dilihat oleh semua pihak terkait. Data dari role lain (Perpajakan) ditampilkan sebagai referensi dan tidak
        dapat diedit.
      </p>
    </div>
  </div>
  ...
  <div class="form-container">
    <form action="{{ route('documents.akutansi.update', $dokumen->id) }}" method="POST" id="editForm">
      @csrf
      @method('PUT')
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" name="nomor_miro" id="nomor_miro" placeholder="Masukkan nomor MIRO"
                  value="{{ old('nomor_miro', $dokumen->nomor_miro_display ?? '') }}">
                @error('nomor_miro')
                  <div class="text-danger" style="color: #dc3545; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                @enderror
              </div>
      ...
      <div class="form-actions">
        <a href="{{ route('documents.akutansi.index') }}" class="btn-reset">
