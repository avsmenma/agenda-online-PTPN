      ...
      <table class="table table-enhanced mb-0">
        ...
        */
        ...
        function openBulkConfirmModal() {
            ...
            document.getElementById('summaryDestination').textContent = 'Team Pembayaran';
        ...
        async function executeBulkSend() {
            ...
            document.getElementById('loadingText').textContent = `Mengirim ${documentIds.length} dokumen ke Team Pembayaran...`;
