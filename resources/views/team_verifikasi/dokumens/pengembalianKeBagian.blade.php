...
@section('content')
    ...
    @if($dokumens->count() > 0)
      <div class="alert-banner">
        ...
        <div class="alert-banner-content">
          <div class="alert-banner-title">Perhatian: Terdapat {{ $dokumens->total() }} dokumen yang dikembalikan dan perlu
            revisi segera.</div>
                ...
                <tr class="main-row" onclick="openViewDocumentModal({{ $dokumen->id }})" style="cursor: pointer;">
                  ...
                  <td onclick="event.stopPropagation()">
                    <div class="action-buttons">
                      <a href="{{ route('documents.verifikasi.edit', $dokumen->id) }}" class="btn-action btn-fix"
                        title="Perbaiki Data"
  ...
  <div class="modal fade" id="sendToNextHandlerConfirmationModal" tabindex="-1"
    aria-labelledby="sendToNextHandlerConfirmationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <h5 class="fw-bold mb-3">Apakah Anda yakin dokumen ini sudah diperbaiki dan ingin dikirim ke team selanjutnya?
          </h5>
  ...
  <script>
    ...
    function sendToNextHandler(docId) {
      ...
      if (docData.return_source) {
        targetHandler = docData.return_source;
        ...
        // Default to perpajakan if no return_source
