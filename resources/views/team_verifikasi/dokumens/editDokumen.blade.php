  ...
  <div class="info-alert">
    ...
    <div class="info-alert-content">
      ...
      <p class="info-alert-text">
        Sebagai Team Verifikasi, Anda dapat mengedit semua data dokumen. Perubahan yang Anda lakukan akan tersimpan dan
  ...
  <div class="form-container">
    <form action="{{ route('documents.verifikasi.update', $dokumen->id) }}" method="POST" id="editForm">
      ...
      <div class="form-actions">
        <a href="{{ route('documents.verifikasi.index') }}" class="btn-reset"
