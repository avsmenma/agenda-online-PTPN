...
@section('content')
  ...
  <style>
    /* Bento Grid for Verifikasi Stats */
    ...
    .vstat-icon--verifikasi { background: rgba(8,62,64,0.1); color: #083E40; }
  ...
  <div class="vstat-grid">
    ...
    <!-- Card 2: Total Dokumen Verifikasi -->
  ...
  <style>
    ...
    #documentTableContainer .badge-status {
      max-width: 100%;
      min-width: 0;
      white-space: normal;
      overflow-wrap: anywhere;
    ...
    #documentTableContainer .document-handler-select {
      width: 100%;
      max-width: 100%;
    }
    ...
    #documentTableContainer .data-table tbody .col-handler select,
    #documentTableContainer .data-table tbody .col-handler .document-handler-select {
      position: relative;
      z-index: 1;
    }
