...
@section('content')
  ...
  <div class="info-alert">
    ...
    <div class="info-alert-content">
      ...
      <p class="info-alert-text">
        Sebagai Team Pembayaran, Anda dapat mengedit semua data dokumen. Perubahan yang Anda lakukan akan tersimpan dan
        dapat dilihat oleh semua pihak terkait. Data dari role lain (Perpajakan, Akutansi) ditampilkan sebagai referensi
  ...
  @if(session('error'))
    <div class="alert alert-danger"
      style="background: #f8d7da; color: #721c24; padding: 15px 20px; border-radius: 10px; margin-bottom: 24px; border-left: 4px solid #dc3545;">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" name="bagian" placeholder="Masukkan bagian"
                  value="{{ old('bagian', $dokumen->bagian) }}">
                @error('bagian')
                  <div class="text-danger" style="color: #dc3545; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group">
                ...
                <input type="text" name="nama_pengirim" placeholder="Masukkan nama pengirim"
          ...
          <div class="accordion-content active">
            <div class="accordion-body">
              ...
              <div
                ...
                <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: #664d03;">
                  <li>Isi field yang tersedia sesuai dengan dokumen pajak</li>
                  <li>Untuk field angka (DPP, PPh): masukkan angka saja (contoh: 1000000), sistem akan memformat otomatis
                  </li>
              ...
              <div class="form-row">
                <div class="info-item">
                  <div class="info-label"><i class="fa-solid fa-receipt me-1"></i> No Faktur</div>
                  <div class="info-value">{{ $dokumen->no_faktur ?? '-' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label"><i class="fa-solid fa-calendar me-1"></i> Tanggal Faktur</div>
                  <div class="info-value">{{ $dokumen->tanggal_faktur ? $dokumen->tanggal_faktur->format('d/m/Y') : '-' }}
                  </div>
                </div>
              </div>

              <!-- Tgl. Selesai Verifikasi Pajak & Jenis PPh -->
              <div class="form-row" style="margin-top: 15px;">
                <div class="info-item">
                  <div class="info-label"><i class="fa-solid fa-clock me-1"></i> Tgl. Selesai Verifikasi Pajak</div>
                  <div class="info-value">
                    {{ $dokumen->tanggal_selesai_verifikasi_pajak ? $dokumen->tanggal_selesai_verifikasi_pajak->format('d/m/Y') : '-' }}
                  </div>
                </div>
                <div class="info-item">
                  <div class="info-label"><i class="fa-solid fa-tag me-1"></i> Jenis PPh</div>
              ...
              <!-- Dasar Pengenaan Pajak (link/info) -->
              @if($dokumen->keterangan_pajak)
                <div style="margin-top: 15px;">
                  <div class="info-item">
                    <div class="info-label">Dasar Pengenaan Pajak</div>
      ...
      <div class="accordion-section pembayaran-section">
        ...
        <div class="accordion-content active">
          <div class="accordion-body">
            <!-- Petunjuk Pengisian -->
            <div
              style="background: linear-gradient(135deg, #e8f5e9 0%, #f1f8e9 100%); border: 1px solid #c8e6c9; border-radius: 10px; padding: 15px 20px; margin-bottom: 20px; display: flex; align-items: flex-start; gap: 12px;">
              ...
              <div>
                ...
                <span style="color: #2e7d32; font-size: 13px;">Isi minimal salah satu dari Tanggal Pembayaran atau Link
                  Google Drive Bukti Pembayaran untuk mengubah status dokumen menjadi "Sudah Dibayar".</span>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="date" name="tanggal_dibayar"
            ...
            <div class="form-group">
              ...
              <input type="url" name="link_bukti_pembayaran"
            ...
            <div class="form-group">
              ...
              <textarea name="catatan_pembayaran" rows="3"
                placeholder="Masukkan catatan tambahan jika diperlukan...">{{ old('catatan_pembayaran', $dokumen->catatan_pembayaran) }}</textarea>
