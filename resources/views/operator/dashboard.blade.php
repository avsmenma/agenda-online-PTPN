...
@section('content')
      ...
      <div class="stat-card">
        <div class="stat-card-body">
          ...
          <div class="stat-content">
            ...
            <div class="stat-description">Menunggu untuk dikirim ke Team Verifikasi</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="stat-card">
        <div class="stat-card-body">
          ...
          <div class="stat-content">
            ...
            <div class="stat-description">Telah dikirim ke Team Verifikasi</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="table-container">
    <h6>
      ...
      <a href="{{ route('documents.index') }}" style="color: #1a4d3e; text-decoration: none; font-size: 14px;">View
        All</a>
    </h6>
              ...
              <tr>
                ...
                <td>
                  ...
                  @else
                    <span class="badge badge-sent">
                      <i class="fas fa-check-circle"></i>
                      Sudah Dikirim ke Team Verifikasi
                    </span>
                  @endif
                </td>
                <td>
