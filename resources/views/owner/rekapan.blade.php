...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="row mb-4">
      <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
        <div class="stat-card" style="cursor: pointer;"
          onclick="window.location.href='{{ route('owner.rekapan.detailStats', ['type' => 'total']) }}'">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
        <div class="stat-card" style="cursor: pointer;"
          onclick="window.location.href='{{ route('owner.rekapan.detailStats', ['type' => 'selesai']) }}'">
          <div class="d-flex align-items-center justify-content-between">
            <div style="flex: 1;">
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
        <div class="stat-card" style="cursor: pointer;"
          onclick="window.location.href='{{ route('owner.rekapan.detailStats', ['type' => 'perpajakan']) }}'">
          <div class="d-flex align-items-center justify-content-between">
            <div style="flex: 1;">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
        <div class="stat-card" style="cursor: pointer;"
          onclick="window.location.href='{{ route('owner.rekapan.detailStats', ['type' => 'akutansi']) }}'">
          <div class="d-flex align-items-center justify-content-between">
            <div style="flex: 1;">
      ...
      <form method="GET" action="{{ url('/owner/rekapan') }}" class="row g-3">
        <div class="col-md-3">
          ...
          <input type="text" name="search" class="form-control" value="{{ request('search') }}"
            placeholder="Nomor agenda, SPP, dll">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
          ...
          <select name="completion_status" class="form-select">
            ...
            <option value="belum_selesai" {{ $completionFilter == 'belum_selesai' ? 'selected' : '' }}>Belum Selesai
            </option>
          </select>
        </div>
        <div class="col-md-1">
        ...
        <table class="table table-hover">
          ...
          <tbody>
            @forelse($dokumens as $index => $dokumen)
              <tr class="main-row" onclick="toggleDetail({{ $dokumen->id }})" style="cursor: pointer;"
                title="Klik untuk melihat detail lengkap dokumen" data-id="{{ $dokumen->id }}">
                ...
                <td>
                  <span class="badge"
                    style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); color: white; padding: 6px 12px; border-radius: 12px; font-size: 11px; font-weight: 600;">
                    {{ $dokumen->bagian ?? '-' }}
                  </span>
                </td>
