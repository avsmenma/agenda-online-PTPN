...
@if($paginator->total() > 0)
  <div class="pagination-enhanced-wrapper"
    style="margin-top: 24px; padding: 20px; background: #f8f9fa; border-radius: 12px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
    ...
    <div class="pagination-enhanced-left" style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap;">
      ...
      <select class="pagination-enhanced-select" onchange="changePerPageEnhanced(this.value)"
        style="padding: 8px 12px; border: 1px solid #dee2e6; border-radius: 8px; background: white; cursor: pointer; font-size: 14px; min-width: 70px;">
    ...
    <div class="pagination-enhanced-right" style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
      <!-- Previous Button -->
      <button class="pagination-enhanced-btn" onclick="goToPageEnhanced({{ $currentPage - 1 }})" {{ $currentPage == 1 ? 'disabled' : '' }}
      ...
      <!-- Page Number Input -->
      <input type="number" class="pagination-enhanced-page-input" value="{{ $currentPage }}" min="1" max="{{ $lastPage }}"
        onchange="goToPageEnhanced(this.value)" onkeypress="if(event.key === 'Enter') goToPageEnhanced(this.value)"
      ...
      <!-- Next Button -->
      <button class="pagination-enhanced-btn" onclick="goToPageEnhanced({{ $currentPage + 1 }})" {{ $currentPage >= $lastPage ? 'disabled' : '' }}
