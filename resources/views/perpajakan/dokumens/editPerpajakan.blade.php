  ...
  <div class="form-container">
    <form action="{{ route('documents.perpajakan.update', $dokumen->id) }}" method="POST" id="editForm">
      ...
      <!-- Section 2: Kriteria CF, Sub Kriteria, Item Sub Kriteria -->
                  ...
                  <div class="form-group">
                    ...
                    @else
                      <input type="text" name="jenis_pembayaran" id="jenis_pembayaran"
                        value="{{ old('jenis_pembayaran', $dokumen->jenis_pembayaran ?? '') }}"
                        placeholder="Masukkan Jenis Pembayaran">
                      <small style="color: #666; font-size: 11px; margin-top: 4px; display: block;">
                        <i class="fas fa-info-circle"></i> Database jenis pembayaran tidak tersedia. Silakan isi manual sesuai
                        kebutuhan.
                      </small>
                    @endif
        ...
        <div class="accordion-section">
          ...
          <div class="accordion-content active">
            <div class="accordion-body">
              ...
              <!-- No SPK, Tanggal SPK, Tanggal Berakhir SPK -->
        ...
        <!-- Section 6: Informasi Perpajakan -->
        <div class="accordion-section perpajakan-section">
          ...
          <div class="accordion-content active">
            <div class="accordion-body">
              ...
              <!-- Row 2: Tanggal Selesai Verifikasi & Jenis PPh -->
              <div class="form-row">
                <div class="form-group">
                  <label for="tanggal_selesai_verifikasi_pajak">
                    <i class="fa-solid fa-check-circle me-1"></i>Tgl. Selesai Verifikasi Pajak
                  </label>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <label for="ppn_terhutang">
                    <i class="fa-solid fa-calculator me-1"></i>PPh Terhutang
                  </label>
