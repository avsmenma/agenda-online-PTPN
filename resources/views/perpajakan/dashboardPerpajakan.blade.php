...
@section('content')
  ...
  <style>
    ...
    /* Icon Colors for Each Statistic - Tax Theme */
    .stat-icon.total {
      background: linear-gradient(135deg, #1a4d3e 0%, #0f3d2e 100%);
    }
  ...
  <!-- Statistics Cards - Row 1: Agenda, Total Perpajakan, Proses, Terkirim -->
  <div class="row mb-3">
    ...
    <!-- Total Dokumen Perpajakan -->
    <div class="col-xl-3 col-lg-3 col-md-6 mb-3">
      <a href="{{ route('documents.perpajakan.index') }}" class="stat-card-link">
        <div class="stat-card">
          <div class="stat-card-body">
            ...
            <div class="stat-content">
              <div class="stat-title">Total Dokumen Perpajakan</div>
              <div class="stat-value">{{ number_format($totalDokumen ?? 0, 0, ',', '.') }}</div>
              <div class="stat-description">Dokumen di perpajakan</div>
            </div>
          </div>
        </div>
      </a>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-3">
      <a href="{{ route('documents.perpajakan.index', ['status' => 'sedang_proses']) }}" class="stat-card-link">
        <div class="stat-card">
          <div class="stat-card-body">
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-3">
      <a href="{{ route('documents.perpajakan.index', ['status' => 'terkirim']) }}" class="stat-card-link">
        <div class="stat-card">
          <div class="stat-card-body">
