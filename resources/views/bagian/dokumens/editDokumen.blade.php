    ...
    <form action="{{ route('bagian.documents.update', $dokumen) }}" method="POST">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="text" name="nama_pengirim" placeholder="Masukkan nama pengirim dokumen"
            value="{{ old('nama_pengirim', $dokumen->nama_pengirim) }}" data-autocomplete="document-senders">
          @error('nama_pengirim')
            <div class="text-danger" style="color: #dc3545; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <textarea name="uraian_spp"
            ...
            data-autocomplete="document-descriptions">{{ old('uraian_spp', $dokumen->uraian_spp) }}</textarea>
          @error('uraian_spp')
            <div class="text-danger" style="color: #dc3545; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="text" name="nilai_rupiah" id="nilai_rupiah" placeholder="123456"
            value="{{ old('nilai_rupiah', $dokumen->nilai_rupiah ? number_format((float) $dokumen->nilai_rupiah, 0, ',', '.') : '') }}">
          @error('nilai_rupiah')
            <div class="text-danger" style="color: #dc3545; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="form-group">
        ...
        @foreach($dokumen->dokumenPrs as $index => $dokumenPR)
          <div class="dynamic-field" data-field-type="pr">
            <input type="text" placeholder="Masukkan nomor PR" name="nomor_pr[]" value="{{ $dokumenPR->nomor_pr }}"
              data-autocomplete="pr-numbers">
            @if($index == 0)
      ...
      <div class="form-group">
        ...
        @foreach($dokumen->dokumenPos as $index => $dokumenPO)
          <div class="dynamic-field" data-field-type="po">
            <input type="text" placeholder="Masukkan nomor PO" name="nomor_po[]" value="{{ $dokumenPO->nomor_po }}"
              data-autocomplete="po-numbers">
            @if($index == 0)
              <button type="button" class="add-field-btn">+</button>
            @else
              <button type="button" class="add-field-btn">+</button>
      ...
      <div class="form-group">
        ...
        @foreach($dokumen->dibayarKepadas as $index => $dibayarKepada)
          <div class="dynamic-field" data-field-type="dibayar_kepada">
            <input type="text" placeholder="Masukkan nama penerima" name="dibayar_kepada[]"
              value="{{ $dibayarKepada->nama_penerima }}" data-autocomplete="payment-recipients">
            @if($index == 0)
              <button type="button" class="add-field-btn">+</button>
            @else
              <button type="button" class="add-field-btn">+</button>
        ...
        @if($dokumen->dibayarKepadas->count() == 0)
          <div class="dynamic-field" data-field-type="dibayar_kepada">
            <input type="text" placeholder="Masukkan nama penerima" name="dibayar_kepada[]"
              data-autocomplete="payment-recipients">
            <button type="button" class="add-field-btn">+</button>
            <button type="button" class="remove-field-btn" style="display: none;">−</button>
          </div>
        @endif
      ...
      <div class="form-row-3">
        ...
        <div class="form-group">
          ...
          <input type="date" name="tanggal_berita_acara"
            value="{{ old('tanggal_berita_acara', $dokumen->tanggal_berita_acara?->format('Y-m-d')) }}">
      ...
      <div class="form-row-2">
        ...
        <div class="form-group">
          ...
          <input type="date" name="tanggal_berakhir_spk"
            value="{{ old('tanggal_berakhir_spk', $dokumen->tanggal_berakhir_spk?->format('Y-m-d')) }}">
      ...
      <div class="form-actions">
        <a href="{{ route('bagian.documents.index') }}" class="btn-back">
